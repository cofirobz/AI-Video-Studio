"""Plain ffmpeg editor provider (no NLE, direct command-line assembly) — not yet implemented."""
...
_NOT_IMPLEMENTED = "ffmpeg integration not yet implemented — see docs/roadmap.md"


class FFmpegEditor(EditorProvider):
